...
const TaskItem: React.FC<TaskItemProps> = ({ task, onToggle, onDelete }) => {
  ...
  return (
    <div className={`p-4 mb-2 border rounded-lg ${task.completed ? 'bg-green-50' : 'bg-white'} ${isOverdue ? 'border-red-300' : 'border-gray-200'}`}>
      <div className="flex items-start justify-between">
        <div className="flex items-start">
          <input
            ...
            className="mr-3 mt-1 h-5 w-5 text-blue-600 rounded focus:ring-blue-500"
          />
